...
if __name__ == '__main__':
    ...
    for i in range(500):
        if i < 10:
            seg = imageio.imread('preds/000'+str(i)+'.png')
            img = imageio.imread('hw2_data/val/img/000'+str(i)+'.png')
        elif i < 100:
            seg = imageio.imread('preds/00' + str(i) + '.png')
            img = imageio.imread('hw2_data/val/img/00' + str(i) + '.png')
        else:
            seg = imageio.imread('preds/0' + str(i) + '.png')
            img = imageio.imread('hw2_data/val/img/0' + str(i) + '.png')
        ...
        result.save('masks/exp'+str(i)+'.png')
